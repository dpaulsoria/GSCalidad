...
export default function LoginScreen() {
  ...
  return (
    <View className="flex-1">
      ...
      <View className=" relative flex-1 bg-slate-300  justify-center items-center">
        ...
        <View className="w-full absolute bottom-0">
          <Svg height="100" width="100%" viewBox="0 0 1440 320" preserveAspectRatio="none">
            <Path
              fill="#fff" // Color blanco para la parte superior
      ...
      <View className="w-min">
        <Text className="bg-slate-500">Hoal Mundo</Text>
      </View>
      <View className="flex-1 bg-blue px-4 pt-8  gap-12 ">
        ...
        <TouchableOpacity className="w-full h-12 bg-table-header-dark rounded-lg justify-center items-center">
          <Text className="text-white text-lg font-semibold">Iniciar Sesión</Text>
        </TouchableOpacity>
        {/* Texto de "Olvidé mi contraseña" */}
        <Text className="text-blue-400 text-center">Olvidé mi contraseña</Text>
      </View>
    </View>
  );
}
