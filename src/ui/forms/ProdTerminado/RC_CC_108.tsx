...
export default function ProdTerminadoScreen() {
  const { state, handleChange, resetForm } = useForm<ProdTerminadoModel>(
    {} as ProdTerminadoModel
  );
  ...
  return (
    <ScrollView className="bg-body-light dark:bg-body-dark px-3">
      ...
      <View className="flex flex-row flex-wrap">
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("area", text)}
            value={state.area}
            label="Área"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("tipo_producto", text)}
            value={state.tipo_producto}
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("presentacion", text)}
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("cliente", text)}
            value={state.cliente}
            label="Cliente"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("temperatura", text)}
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("talla_real", text)}
            value={state.talla_real}
            label="Talla Real"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("peso_neto", text)}
            value={state.peso_neto}
            label="Peso Neto"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("glaseo", text)}
            value={state.glaseo}
            label="Glaseo"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("cta_congelada", text)}
            value={state.cta_congelada}
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("cta_final", text)}
            value={state.cta_final}
            label="Cuenta Final"
          />
        </View>
