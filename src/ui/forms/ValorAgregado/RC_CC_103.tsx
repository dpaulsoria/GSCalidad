...
export default function PeladoFrescoScreen() {
  const { state, handleChange, resetForm } = useForm<PeladoFrescoModel>(
    {} as PeladoFrescoModel
  );
  ...
  return (
    <ScrollView className="bg-body-light dark:bg-body-dark px-3">
      ...
      <View className="flex flex-row flex-wrap">
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("name_importador", text)}
            value={state.name_importador}
            label="Importador"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("name_talla", text)}
            value={state.name_talla}
            label="Talla"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("peso_muestra", text)}
            value={state.peso_muestra}
            label="Peso Muestra"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("cuenta_libra", text)}
            value={state.cuenta_libra}
            label="Cuenta por Libra"
          />
        </View>

        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("uniformidad_p", text)}
            value={state.uniformidad_p}
            label="Uniformidad P"
          />
        </View>
        ...
        <View className="w-1/2 p-2">
          <ColumnTextField
            onChange={(text) => handleChange("uniformidad_g", text)}
            value={state.uniformidad_g}
            label="Uniformidad G"
          />
        </View>
